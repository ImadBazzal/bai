...
use App\Repository\PublicistRepository;
 ...
 */
class Publicist implements CelebrityRepresentative
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Representative::class, inversedBy="publicists")
     * @ORM\JoinColumn(nullable=false)
     * @Assert\NotBlank
     * @Groups({"celebrity:read"})
     */
